...
const apikey = '7568e14d723b8c030f55986cad93901d'
...
export default {
  ...
  computed: {
    //Since we're using units=metric in the API call, temperature is already in Celsius
    temperature() {
      return this.weatherData ? Math.round(this.weatherData.main.temp) : null
    },
    //Get the current weather icon using the API link (updated to use https)
    iconUrl() {
